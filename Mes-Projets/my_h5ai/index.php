        ...
        <section class="container-fluid">
            ...
            <div class="row path">
                <div class="col-3 ">
                    ...
                    try {
                        $bdd = new PDO('mysql:host=localhost;dbname=my_h5ai;charset=utf8', 'root', 'azerty3469');
                    } catch (Exception $e) {
                        die('Erreur : ' . $e->getMessage());
                    }
                    $host = $_SERVER['HTTP_HOST'];
                    $uri = $_SERVER['REQUEST_URI']; //li la requête en URL
                    $urii = explode("=", $uri);// séparateur "="
            ...
            <div class="col-12">';
                    ...
                    function list_dir($dir)
                    {
                        ...
                        if (is_dir($dir)) {
                            ...
                            global $filepath;
                            $filepath = glob($dir . "*", GLOB_MARK);//Ajoute un slash final à chaque dossier retourné; * ->Associe zéro ou plus de caractères.
...
';
            ...
            <table class='col-12'>
                <tr id='explo'>
                    ...
                    $test2 = $path . "/" . $test[1];
                    $test3 = $test[1];
                    $test4 = rtrim($test3, 1); //supprime les espaces ou autres caractères prédéfinis du côté droit d'une chaîne
                    ...
                    function list_url($test3)
                    {
                        ...
                        if (file_exists($test3)) {
                            ...
                            if (is_dir($test3)) {
                                ...
                                $dirop = opendir($test3);//Ouvre un dossier, et récupère un pointeur dessus
...
// ----------------------------------TRI----------------------------------------------------------------
                                ...
                                if ($_POST['tri'][0] == "modification") {
                                    ...
                                    if ($_POST['tri'][1] == "modification" and $_POST['tri'][0] == "taille") {
                                        ...
                                        array_multisort($modification, SORT_ASC, $taille, SORT_ASC, $data); //Trie un tableau en ordre croissant
